...
<details>
  ...
  <br>
   ...
   <img width="861" height="555" alt="image" src="https://github.com/user-attachments/assets/4b8e3b37-faaa-46f9-9f4f-58bd8a48b722" />
   ...
   3. Физический, канальный, сетевой - **уровни среды**; остальные - **уровни хоста**.

   4. Уровни прикладной, представления, сеансовый работают с данными.

   5. Транспортный с сегментами.
...
<details>
   ...
   * **MSS** - максимальный размер полезных данных, который может быть отправлен в одном сегменте (пакете), и не включает заголовки TCP и IP.

   * **MTU** (maximum transmission unit) - максимальный размер полезного блока данных, который может быть передан протоколом без фрагментации. Размер части должен быть таков, чтобы не был превышен MTU на сетевом уровне.
