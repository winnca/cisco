...
<details>
   ...
   * **MTU** (maximum transmission unit) - максимальный размер полезного блока данных, который может быть передан протоколом без фрагментации. Размер части должен быть таков, чтобы не был превышен MTU на сетевом уровне. (важен на канальном уровне модели OSI)
