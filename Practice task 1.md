...
<details>
   ...
   * **MTU** (maximum transmission unit) - максимальный размер полезного блока данных, который может быть передан протоколом без фрагментации.
   ...
   * **Управление соединениями** в TCP — это установление и поддержка логической связи между двумя устройствами.
